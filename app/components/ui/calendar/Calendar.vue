...
const props = withDefaults(defineProps<CalendarRootProps & { class?: HTMLAttributes["class"], layout?: LayoutTypes, yearRange?: DateValue[], type?: 'single' | 'range' }>(), {
...
}) as Ref<DateValue | { start: DateValue, end: DateValue }>
...
<template>
  ...
  <component
    :is="type === 'range' ? RangeCalendarRoot : CalendarRoot"
